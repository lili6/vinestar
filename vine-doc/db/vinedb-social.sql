...
-- ----------------------------
-- Table structure for c_social_comment
-- ----------------------------
DROP TABLE IF EXISTS `c_social_comment`;
CREATE TABLE `c_social_comment` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `content` varchar(255) DEFAULT NULL COMMENT '评论内容',
  `topicId` int(11) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL COMMENT '评论用户Id',
  ...
  `enabled` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='社交--话题评论表';

-- ----------------------------
-- Records of c_social_comment
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_favorite
-- ----------------------------
DROP TABLE IF EXISTS `c_social_favorite`;
CREATE TABLE `c_social_favorite` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '收藏Id',
  `topicId` int(11) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL COMMENT '被赞用户Id',
  `createTime` datetime DEFAULT NULL,
  `creator` varchar(30) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `updater` varchar(30) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='社交--话题评论表';

-- ----------------------------
-- Records of c_social_favorite
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_letter
-- ----------------------------
DROP TABLE IF EXISTS `c_social_letter`;
CREATE TABLE `c_social_letter` (
  ...
  `fromUid` varchar(11) DEFAULT NULL COMMENT '发送方',
  `toUid` varchar(255) DEFAULT NULL COMMENT '接受方',
  `isRead` tinyint(1) DEFAULT '0' COMMENT '是否已读，发送方也提示此消息已读 0:未，1：已读',
  `createTime` datetime DEFAULT NULL,
  `creator` varchar(30) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `updater` varchar(30) DEFAULT NULL,
...
-- ----------------------------
-- Records of c_social_letter
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_notice
-- ----------------------------
DROP TABLE IF EXISTS `c_social_notice`;
CREATE TABLE `c_social_notice` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'noticeId',
  `noticeType` tinyint(4) DEFAULT NULL COMMENT '通知类型(被赞，被评论，被转发,被@),都是与',
  `userId` varchar(255) DEFAULT NULL COMMENT '用户Id',
  `topicId` int(11) DEFAULT NULL COMMENT '话题ID',
  `commentId` int(11) DEFAULT NULL,
  `praiseId` int(11) DEFAULT NULL COMMENT '赞ID',
  `isRead` tinyint(1) DEFAULT '0' COMMENT '是否已读，发送方也提示此消息已读 0:未，1：已读',
  `createTime` datetime DEFAULT NULL,
  `creator` varchar(30) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
...
-- ----------------------------
-- Records of c_social_notice
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_praise
-- ----------------------------
DROP TABLE IF EXISTS `c_social_praise`;
CREATE TABLE `c_social_praise` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `topicId` int(11) DEFAULT NULL,
  `userId` varchar(255) DEFAULT NULL COMMENT '被赞用户Id',
  `praiseUserId` int(11) DEFAULT NULL COMMENT '点赞用户',
  `isRead` tinyint(4) DEFAULT NULL,
  `realtionship` tinyint(4) DEFAULT NULL COMMENT '好友关系',
  `createTime` datetime DEFAULT NULL,
  `creator` varchar(30) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `updater` varchar(30) DEFAULT NULL,
...
-- ----------------------------
-- Records of c_social_praise
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_request
-- ----------------------------
DROP TABLE IF EXISTS `c_social_request`;
CREATE TABLE `c_social_request` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'requestId',
  `userId` varchar(255) DEFAULT NULL COMMENT '被赞用户Id',
  `requestUserId` int(11) DEFAULT NULL COMMENT '点赞用户',
  `isRead` tinyint(1) DEFAULT '0' COMMENT '是否已读，发送方也提示此消息已读 0:未，1：已读',
  `isAgree` tinyint(4) DEFAULT NULL COMMENT '是否同意',
...
-- ----------------------------
-- Records of c_social_request
-- ----------------------------

-- ----------------------------
-- Table structure for c_social_topic
-- ----------------------------
DROP TABLE IF EXISTS `c_social_topic`;
CREATE TABLE `c_social_topic` (
  ...
  `thumbnail` varchar(100) DEFAULT NULL COMMENT '缩略图Url',
  `image` varchar(255) DEFAULT NULL COMMENT '图片URL',
  `localImage` varchar(255) DEFAULT NULL COMMENT '本地图片URL',
  `userId` varchar(255) DEFAULT NULL COMMENT '用户id，发布话题者',
  `visibleRange` tinyint(4) DEFAULT NULL,
  `praiseCount` int(11) DEFAULT NULL COMMENT '赞数',
  `commentCount` int(11) DEFAULT NULL COMMENT '评论数',
  `forwardCount` int(11) DEFAULT NULL COMMENT '转发次数',
  `favoriteCount` int(11) DEFAULT NULL COMMENT '被收藏次数',
  `status` tinyint(4) DEFAULT NULL COMMENT '话题状态',
  `createTime` datetime DEFAULT NULL,
  `creator` varchar(30) DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `updater` varchar(30) DEFAULT NULL,
...
CREATE TABLE `c_user_friend` (
  ...
  `friendId` varchar(11) DEFAULT NULL COMMENT '好友Id',
...
CREATE TABLE `c_user_info` (
  ...
  `userId` varchar(50) NOT NULL COMMENT '与用户表对应',
  ...
  `county` varchar(10) DEFAULT NULL COMMENT '国家缩写',
