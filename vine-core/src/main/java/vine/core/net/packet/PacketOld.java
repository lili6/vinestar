 ...
 *
 */
public abstract class PacketOld {
    private static final Logger log = LoggerFactory.getLogger(PacketOld.class);
	 ...
	 * @return 封装好的数据对象
	 */
	public static PacketOld parseHttpRequest(byte[] data, PacketType type) {
		if (packetType == null) packetType = type;
		
		PacketOld packet = null;
	 ...
	 */
	public static byte[] packHttpResponse(PacketOld packet, PacketType type) {
		byte[] response = null;
	 ...
	 * @return Packet
	 */
	public static PacketOld packError(int packetId, int retCode, PacketType type) {
		PacketOld packet = null;
	 ...
	 * @return
	 */
	public static PacketOld newPbPacket(int packetId, Object data) {
		PacketOld result = new PbPacket();
	 ...
	 * @return
	 */
	public static PacketOld newJsonPacket(int packetId, Object data) {
		PacketOld result = new JsonPacket();
		result.setPacketId(packetId);
		result.setData(data);		
		return result;
	}
	...
	public String toString() {
		return "AbstractPacket [packetId=" + packetId + ", stamp=" + stamp
