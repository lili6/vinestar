...
public class GameActionTaskResultListener implements ActionTaskResultListener {
	...
	@Override
	public void receiveResult(ActionHandler handler, HttpPacket data) {
		sendData(sessions, handler, data);
	}
	
	public static void sendData(UserSession[] sessions, ActionHandler handler, HttpPacket packet) {
		int requestCmd = 1;
